...
const compare = (originalSource, snapshotSource) => {
    const originalDocument = (0, src_1.createHTMLDocument)(originalSource, 'http://example.com');
    const snapshotDocument = (0, src_1.createHTMLDocument)(snapshotSource, 'http://example.com');
    ...
    const foundElement = (0, src_1.findOriginalElement)(originalDocument, snapshotElement);
...
(0, ava_1.default)('Find by URL match (src)', (t) => {
...
(0, ava_1.default)('Find by URL no match (src)', (t) => {
    const result = compare(`
            <img src="test1.png">
        `, `
            <img src="test1.png">
...
(0, ava_1.default)('Find by nth URL match (src)', (t) => {
    const result = compare(`
            <img src="test2.png">
            <img data-original src="test2.png">
        `, `
...
(0, ava_1.default)('Find by URL match (href)', (t) => {
    const result = compare(`
...
(0, ava_1.default)('Find by content match (script)', (t) => {
    const result = compare(`
...
(0, ava_1.default)('Find by URL or content no match (script)', (t) => {
    const result = compare(`
...
(0, ava_1.default)('Find by nth content match (button)', (t) => {
    const result = compare(`
            <button>OK</button>
...
(0, ava_1.default)('Find by first class match (div)', (t) => {
    const result = compare(`
...
(0, ava_1.default)('Find by first class no match (div)', (t) => {
    const result = compare(`
            <div class="first">Test</div>
        `, `
            <div class="first">Test</div>
...
(0, ava_1.default)('Find by singleton match (html)', (t) => {
    const result = compare(`
            <html data-original>
                Test
            </html>
...
(0, ava_1.default)('Find by nth match (tr)', (t) => {
    const result = compare(`
            <table>
                <tr><td>Data</td></tr>
...
(0, ava_1.default)('Find by nth no match (tr)', (t) => {
    const result = compare(`
            <table>
                <tr><td>Data</td></tr>
                <tr><td>Data</td></tr>
