...
function speakersection(){
    for(speaker in speakers){
        const speakerp = speakers[speaker].name;
        const imagespeaker = speakers[speaker].imgspkeaker;
        const studies = speakers[speaker].studies;
        const topic = speakers[speaker].topic;
